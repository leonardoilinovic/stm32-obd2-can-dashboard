...
#define RST_A() HAL_GPIO_WritePin(TFT_RESET_GPIO_Port,TFT_RESET_Pin, GPIO_PIN_RESET)
#define RST_D() HAL_GPIO_WritePin(TFT_RESET_GPIO_Port,TFT_RESET_Pin, GPIO_PIN_SET)
...
#define DC_COMMAND() HAL_GPIO_WritePin(TFT_DC_RS_GPIO_Port, TFT_DC_RS_Pin, GPIO_PIN_RESET)
#define DC_DATA() HAL_GPIO_WritePin(TFT_DC_RS_GPIO_Port, TFT_DC_RS_Pin, GPIO_PIN_SET)
